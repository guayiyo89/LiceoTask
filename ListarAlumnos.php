...
<html>
    ...
    <body>
        ...
        $sql = "SELECT Nombre, Apellido, Rut, Colegio, Comuna, FechaNac, Apoderado FROM alumno ORDER BY Apellido LIMIT ".$pinicio."," .$ptotal;
        ...
        if ($result->num_rows > 0){
            ...
            '</td><td width="80">'.$row["Comuna"].'</td><td>'.$row["FechaNac"].'</td><td>'.$row["Apoderado"].'</td></tr>';}
            echo'</table>';
        }
        else{
